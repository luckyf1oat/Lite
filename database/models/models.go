...
type Client struct {
	...
	// NameAutoGenerated records that Name was produced automatically from the
	// node's egress identity. An administrator rename clears it so automatic
	// naming never overwrites a deliberate choice.
	NameAutoGenerated      bool       `json:"name_auto_generated" gorm:"column:name_auto_generated;not null;default:false"`
