...
**当前正式版：Lite [`2.3.4`](https://github.com/nuomiiiii/Lite/releases/tag/2.3.4) · 配套 Agent [`2.3.3.4`](https://github.com/nuomiiiii/Lite-agent/releases/tag/2.3.3.4) · 默认主题 [`1.1.2`](https://github.com/nuomiiiii/Lite-theme/releases/tag/v1.1.2)**
...
- **配套组件更新**：Lite-agent `2.3.3.4` 提供 MCP 完整管理和内存优化；默认 Lite-Theme `1.1.2` 包含手机端显示优化。
...
固定使用当前正式版时，将镜像标签改为 `ghcr.io/nuomiiiii/lite:2.3.4`。
...
Lite `2.3.4` 推荐配套 [Lite-agent `2.3.3.4`](https://github.com/nuomiiiii/Lite-agent/releases/tag/2.3.3.4)。先在后台添加节点，再打开该节点的“节点配置 → 部署指令”，复制完整命令到目标服务器执行。自动发现注册已下线，新安装和 Docker 重建均使用具体节点的部署指令。
